...
def make_optimizer_class(cls):
    ...
    class DPOptimizerClass(cls):
        ...
        def minimize(
            ...
            f_grads = self.dp_compute_gradients(d_loss_fake, var_list=var_list, gate_gradients=gate_gradients,aggregation_method=aggregation_method,colocate_gradients_with_ops=colocate_gradients_with_ops,grad_loss=grad_loss, noise_flag=False)
